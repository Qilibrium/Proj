...
public class ButtonContainer {
    ...
    public ButtonContainer(SendMessageBotService sendMessageBotService) {
        ...
        buttonMap = ImmutableMap.<String, Button>builder()
                ...
                .put(TIME_UPDATE_NINETEEN_CALLBACK.getCallback(), timeUpdateButton)
                .put(TIME_UPDATE_TWENTY_CALLBACK.getCallback(), timeUpdateButton)
                .put(TIME_UPDATE_TWENTY_ONE_CALLBACK.getCallback(), timeUpdateButton)
