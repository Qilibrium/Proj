...
public class TimeUpdateButton implements Button {
    ...
    private final static String MESSAGE = "⏱  Оберіть час сповіщення";
    ...
    private List<InlineKeyboardButton> buttonsRow6 = new ArrayList<>();
    ...
    public TimeUpdateButton(SendMessageBotService sendMessageBotService) {
        ...
        buttonsRow2.add(InlineKeyboardButton.builder().text(TIME_UPDATE_THEN.getName()).callbackData(TIME_UPDATE_THEN_CALLBACK.getCallback()).build());
        ...
        buttonsRow5.add(InlineKeyboardButton.builder().text(TIME_UPDATE_NINETEEN.getName()).callbackData(TIME_UPDATE_NINETEEN_CALLBACK.getCallback()).build());
        buttonsRow5.add(InlineKeyboardButton.builder().text(TIME_UPDATE_TWENTY.getName()).callbackData(TIME_UPDATE_TWENTY_CALLBACK.getCallback()).build());

        buttonsRow6.add(InlineKeyboardButton.builder().text(TIME_UPDATE_TWENTY_ONE.getName()).callbackData(TIME_UPDATE_TWENTY_ONE_CALLBACK.getCallback()).build());
        buttonsRow6.add(InlineKeyboardButton.builder().text(TIME_UPDATE_DISABLE.getName()).callbackData(TIME_UPDATE_DISABLE_CALLBACK.getCallback()).build());
        buttonsRow6.add(InlineKeyboardButton.builder().text(BACK.getName()).callbackData(BACK_CALLBACK.getCallback()).build());
